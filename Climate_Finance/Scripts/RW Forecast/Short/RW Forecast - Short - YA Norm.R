...
#### Boosting ####
load("Scripts/RW Forecast/Short/Objects/norm-YA-boosting05-env.RData")
...
#save.image(file = "Scripts/RW Forecast/Short/Objects/norm-YA-boosting05-env.RData")

#### Linear ####
load("Scripts/RW Forecast/Short/Objects/norm-YA-linear05-env.RData")
...
YA_m1_fc <- rwf_lm2(YA_m1_data,0.5, norm = T)
YA_m2_fc <- rwf_lm2(YA_m2_data,0.5, norm = T)
YA_m3_fc <- rwf_lm2(YA_m3_data,0.5, norm = T)
YA_m4_fc <- rwf_lm2(YA_m4_data,0.5, norm = T)
YA_m5_fc <- rwf_lm2(YA_m5_data,0.5, norm = T)
YA_m6_fc <- rwf_lm2(YA_m6_data,0.5, norm = T)
...
#save.image(file = "Scripts/RW Forecast/Short/Objects/norm-YA-linear05-env.RData")