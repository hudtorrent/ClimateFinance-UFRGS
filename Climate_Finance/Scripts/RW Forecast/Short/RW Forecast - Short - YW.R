...
#load("Scripts/RW Forecast/Short/Objects/YW-boosting-env.RData")
...
#save.image(file = "Scripts/RW Forecast/Short/Objects/YW-boosting05-env.RData")

#### Linear ####
load("Scripts/RW Forecast/Short/Objects/YW-linear05-env.RData")
#load("Scripts/RW Forecast/Short/Objects/YW-linear-env.RData")
...
YW_m1_fc <- rwf_lm(YW_m1_data,0.5)
YW_m2_fc <- rwf_lm(YW_m2_data,0.5)
YW_m3_fc <- rwf_lm(YW_m3_data,0.5)
YW_m4_fc <- rwf_lm(YW_m4_data,0.5)
YW_m5_fc <- rwf_lm(YW_m5_data,0.5)
YW_m6_fc <- rwf_lm(YW_m6_data,0.5)
...
#save.image(file = "Scripts/RW Forecast/Short/Objects/YW-linear05-env.RData")