...
#load("Scripts/RW Forecast/Short/Objects/2YN-boosting-env.RData")
...
#save.image(file = "Scripts/RW Forecast/Short/Objects/2YN-boosting05-env.RData")

#### Linear ####
load("Scripts/RW Forecast/Short/Objects/2YN-linear05-env.RData")
#load("Scripts/RW Forecast/Short/Objects/2YN-linear-env.RData")
...
YN_m1_fc <- rwf_lm2(YN_m1_data,0.5)
YN_m2_fc <- rwf_lm2(YN_m2_data,0.5)
YN_m3_fc <- rwf_lm2(YN_m3_data,0.5)
YN_m4_fc <- rwf_lm2(YN_m4_data,0.5)
YN_m5_fc <- rwf_lm2(YN_m5_data,0.5)
YN_m6_fc <- rwf_lm2(YN_m6_data,0.5)
...
#save.image(file = "Scripts/RW Forecast/Short/Objects/2YN-linear05-env.RData")