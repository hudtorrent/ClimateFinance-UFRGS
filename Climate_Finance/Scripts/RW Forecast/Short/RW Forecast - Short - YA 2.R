...
#load("Scripts/RW Forecast/Short/Objects/2YA-boosting-env.RData")
...
for (i in 1:6) { 
  names <- paste0("Output/Plots/RW Forecast/Short 2/",plotnames[i],".jpeg")
...
#save.image(file = "Scripts/RW Forecast/Short/Objects/2YA-boosting05-env.RData")

#### Linear ####
load("Scripts/RW Forecast/Short/Objects/2YA-linear05-env.RData")
#load("Scripts/RW Forecast/Short/Objects/2YA-linear-env.RData")
...
YA_m1_fc <- rwf_lm2(YA_m1_data,0.5)
YA_m2_fc <- rwf_lm2(YA_m2_data,0.5)
YA_m3_fc <- rwf_lm2(YA_m3_data,0.5)
YA_m4_fc <- rwf_lm2(YA_m4_data,0.5)
YA_m5_fc <- rwf_lm2(YA_m5_data,0.5)
YA_m6_fc <- rwf_lm2(YA_m6_data,0.5)
...
#save.image(file = "Scripts/RW Forecast/Short/Objects/2YA-linear05-env.RData")