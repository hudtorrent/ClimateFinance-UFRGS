...
#### Boosting ####
load("Scripts/RW Forecast/Short/Objects/h3-YM-boosting05-env.RData")
load("Scripts/RW Forecast/Short/Objects/h6-YM-boosting05-env.RData")
load("Scripts/RW Forecast/Short/Objects/h12-YM-boosting05-env.RData")
...
YM_m6_data[,373:492] <- log(YM_m6_data[,373:492])

YM_m1_fc <- rwf_mboost2(YM_m1_data,0.5, norm = T, h = h)
YM_m1_vars <- vars_freq(variables)
YM_m1_vars_avg <- variables_avg

YM_m2_fc <- rwf_mboost2(YM_m2_data,0.5, norm = T, h = h)
YM_m2_vars <- vars_freq(variables)
YM_m2_vars_avg <- variables_avg

YM_m3_fc <- rwf_mboost2(YM_m3_data,0.5, norm = T, h = h)
YM_m3_vars <- vars_freq(variables)
YM_m3_vars_avg <- variables_avg

YM_m4_fc <- rwf_mboost2(YM_m4_data,0.5, norm = T, h = h)
YM_m4_vars <- vars_freq(variables)
YM_m4_vars_avg <- variables_avg

YM_m5_fc <- rwf_mboost2(YM_m5_data,0.5, norm = T, h = h)
YM_m5_vars <- vars_freq(variables)
YM_m5_vars_avg <- variables_avg

YM_m6_fc <- rwf_mboost2(YM_m6_data,0.5, norm = T, h = h)
...
#save.image(file = "Scripts/RW Forecast/Short/Objects/h12-YM-boosting05-env.RData")

#### Linear ####
load("Scripts/RW Forecast/Short/Objects/h3-YM-linear05-env.RData")
load("Scripts/RW Forecast/Short/Objects/h6-YM-linear05-env.RData")
load("Scripts/RW Forecast/Short/Objects/h12-YM-linear05-env.RData")
...
YM_m1_fc <- rwf_lm2(YM_m1_data,0.5, norm = T, h = h)
YM_m2_fc <- rwf_lm2(YM_m2_data,0.5, norm = T, h = h)
YM_m3_fc <- rwf_lm2(YM_m3_data,0.5, norm = T, h = h)
YM_m4_fc <- rwf_lm2(YM_m4_data,0.5, norm = T, h = h)
YM_m5_fc <- rwf_lm2(YM_m5_data,0.5, norm = T, h = h)
YM_m6_fc <- rwf_lm2(YM_m6_data,0.5, norm = T, h = h)
...
#save.image(file = "Scripts/RW Forecast/Short/Objects/h12-YM-linear05-env.RData")
