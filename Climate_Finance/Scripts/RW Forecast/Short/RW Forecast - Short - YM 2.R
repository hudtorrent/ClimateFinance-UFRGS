...
#load("Scripts/RW Forecast/Short/Objects/2YM-boosting-env.RData")
...
#save.image(file = "Scripts/RW Forecast/Short/Objects/2YM-boosting05-env.RData")

#### Linear ####
load("Scripts/RW Forecast/Short/Objects/2YM-linear05-env.RData")
#load("Scripts/RW Forecast/Short/Objects/2YM-linear-env.RData")
...
YM_m1_fc <- rwf_lm2(YM_m1_data,0.5)
YM_m2_fc <- rwf_lm2(YM_m2_data,0.5)
YM_m3_fc <- rwf_lm2(YM_m3_data,0.5)
YM_m4_fc <- rwf_lm2(YM_m4_data,0.5)
YM_m5_fc <- rwf_lm2(YM_m5_data,0.5)
YM_m6_fc <- rwf_lm2(YM_m6_data,0.5)
...
#save.image(file = "Scripts/RW Forecast/Short/Objects/2YM-linear05-env.RData")