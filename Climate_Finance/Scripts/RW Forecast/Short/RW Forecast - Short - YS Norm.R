...
#### Boosting ####
load("Scripts/RW Forecast/Short/Objects/norm-YS-boosting05-env.RData")
...
#save.image(file = "Scripts/RW Forecast/Short/Objects/norm-YS-boosting05-env.RData")

#### Linear ####
load("Scripts/RW Forecast/Short/Objects/norm-YS-linear05-env.RData")
...
YS_m1_fc <- rwf_lm2(YS_m1_data,0.5, norm = T)
YS_m2_fc <- rwf_lm2(YS_m2_data,0.5, norm = T)
YS_m3_fc <- rwf_lm2(YS_m3_data,0.5, norm = T)
YS_m4_fc <- rwf_lm2(YS_m4_data,0.5, norm = T)
YS_m5_fc <- rwf_lm2(YS_m5_data,0.5, norm = T)
YS_m6_fc <- rwf_lm2(YS_m6_data,0.5, norm = T)
...
#save.image(file = "Scripts/RW Forecast/Short/Objects/norm-YS-linear05-env.RData")