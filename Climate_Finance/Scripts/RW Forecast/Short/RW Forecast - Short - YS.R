...
#load("Scripts/RW Forecast/Short/Objects/YS-boosting-env.RData")
...
#save.image(file = "Scripts/RW Forecast/Short/Objects/YS-boosting05-env.RData")

#### Linear ####
load("Scripts/RW Forecast/Short/Objects/YS-linear05-env.RData")
#load("Scripts/RW Forecast/Short/Objects/YS-linear-env.RData")
...
YS_m1_fc <- rwf_lm(YS_m1_data,0.5)
YS_m2_fc <- rwf_lm(YS_m2_data,0.5)
YS_m3_fc <- rwf_lm(YS_m3_data,0.5)
YS_m4_fc <- rwf_lm(YS_m4_data,0.5)
YS_m5_fc <- rwf_lm(YS_m5_data,0.5)
YS_m6_fc <- rwf_lm(YS_m6_data,0.5)
...
#save.image(file = "Scripts/RW Forecast/Short/Objects/YS-linear05-env.RData")