...
#### Boosting ####
load("Scripts/RW Forecast/Short/Objects/norm-YM-boosting05-env.RData")
...
#save.image(file = "Scripts/RW Forecast/Short/Objects/norm-YM-boosting05-env.RData")

#### Linear ####
load("Scripts/RW Forecast/Short/Objects/norm-YM-linear05-env.RData")
...
YM_m1_fc <- rwf_lm2(YM_m1_data,0.5, norm = T)
YM_m2_fc <- rwf_lm2(YM_m2_data,0.5, norm = T)
YM_m3_fc <- rwf_lm2(YM_m3_data,0.5, norm = T)
YM_m4_fc <- rwf_lm2(YM_m4_data,0.5, norm = T)
YM_m5_fc <- rwf_lm2(YM_m5_data,0.5, norm = T)
YM_m6_fc <- rwf_lm2(YM_m6_data,0.5, norm = T)
...
#save.image(file = "Scripts/RW Forecast/Short/Objects/norm-YM-linear05-env.RData")