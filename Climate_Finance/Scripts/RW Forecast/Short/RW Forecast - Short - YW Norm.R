...
#### Boosting ####
load("Scripts/RW Forecast/Short/Objects/norm-YW-boosting05-env.RData")
...
#save.image(file = "Scripts/RW Forecast/Short/Objects/norm-YW-boosting05-env.RData")

#### Linear ####
load("Scripts/RW Forecast/Short/Objects/norm-YW-linear05-env.RData")
...
YW_m1_fc <- rwf_lm2(YW_m1_data,0.5, norm = T)
YW_m2_fc <- rwf_lm2(YW_m2_data,0.5, norm = T)
YW_m3_fc <- rwf_lm2(YW_m3_data,0.5, norm = T)
YW_m4_fc <- rwf_lm2(YW_m4_data,0.5, norm = T)
YW_m5_fc <- rwf_lm2(YW_m5_data,0.5, norm = T)
YW_m6_fc <- rwf_lm2(YW_m6_data,0.5, norm = T)
...
#save.image(file = "Scripts/RW Forecast/Short/Objects/norm-YW-linear05-env.RData")