...
#load("Scripts/RW Forecast/Long/Objects/2boosting-env.RData")
...
for (i in 1:6) { 
  names <- paste0("Output/Plots/RW Forecast/Long 2/",plotnames[i],".jpeg")
...
#save.image(file = "Scripts/RW Forecast/Long/Objects/2boosting05-env.RData")

#### Linear ####
load("Scripts/RW Forecast/Long/Objects/2linear05-env.RData")
#load("Scripts/RW Forecast/Long/Objects/2linear-env.RData")
...
m1_fc <- rwf_lm2(m1_data,0.5)
m2_fc <- rwf_lm2(m2_data,0.5)
m3_fc <- rwf_lm2(m3_data,0.5)
m4_fc <- rwf_lm2(m4_data,0.5)
m5_fc <- rwf_lm2(m5_data,0.5)
m6_fc <- rwf_lm2(m6_data,0.5)
...
#save.image(file = "Scripts/RW Forecast/Long/Objects/2linear05-env.RData")