...
#save.image(file = "Scripts/RW Forecast/Long/Objects/norm-boosting05-env.RData")

#### Linear ####
load("Scripts/RW Forecast/Long/Objects/norm-linear05-env.RData")
...
#save.image(file = "Scripts/RW Forecast/Long/Objects/norm-linear05-env.RData")